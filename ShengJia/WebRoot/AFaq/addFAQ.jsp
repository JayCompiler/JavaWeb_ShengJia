...
<body>
	...
	<div id="change">
		...
		<% String category=request.getParameter("category"); %>
			<form action="/ShengJia/AddFAQ" method="post">
				<table border="1px">
					<tr>
						<td>标签：</td><td>
							<input type="text" value="<%=category %>" name="category"></td>
						
					</tr>
					<tr><td>问题：</td><td><input type="text" name="question"
							required="required"></td></tr>
					<tr>
						<td>解答：</td><td><textarea cols="50" rows="10" name="answer"
