	...
	<div id="change">
		...
		<div>
			<%
				...
				MainDao fDBO = new MainDao();
				Main faq = fDBO.queryCaseById(id);
			%>
			<form action="/ShengJia/EditMain" method="post">
				<center>
					<table border="1px">
						...
						<tr>
							<td>
							标签：</td>
							<td><input type="text" value="<%=faq.getCategory()%>" name="category"></td>
						</tr>
						<tr>
						<td>标题：</td><td><input type="text" value="<%=faq.getDetail()%>"
						...
						<tr>
							...
							<td><textarea cols="50" rows="10" name="content"
									required="required"><%=faq.getContent()%></textarea></td>
						</tr>
						<tr>
