	...
	<div id="main">
		...
		<div id="content">
			...
			<div id="dSuc">
				<div id="lbt">
					<a
						href="${pageContext.request.contextPath}/SuccServlet?num=<%=page1.getPrePageNum()%>">
				...
				<div id="right">
						...
						<center>
							<table>
								<tr>
									...
									%>
									<td><a href="/ShengJia/OPSuc1?id=<%=re.getId()%>"> <img
					...
					<div id="rbt">
						<a
							href="${pageContext.request.contextPath}/SuccServlet?num=<%=page1.getNextPageNum()%>">
			...
			<div id="foot">
				<center>
					...
					onclick="window.location.href='${pageContext.request.contextPath}/SuccServlet'"
					>首页</button>

				 <button type="button" class="btn btn-info"
					onclick="window.location.href='${pageContext.request.contextPath}/SuccServlet?num=<%=page1.getTotalPage()%>'"
					>尾页</button>
					...
					<script type="text/javascript">
						function jump(selectobj) {
							window.location.href = "${pageContext.request.contextPath}/SuccServlet?num=" + selectobj.value;
						}
					</script>
					<!-- 分页导结束 -->
				</center>
