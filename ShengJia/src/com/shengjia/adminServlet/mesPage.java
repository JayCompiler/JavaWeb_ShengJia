 ...
 */
public class mesPage extends HttpServlet {
	...
	protected void show(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		Page page=mDbo.findpPage(pageNum,10);
		request.setAttribute("pageone", page);
		request.getRequestDispatcher("/adminpage/contactUs.jsp").forward(request,response);
	}
