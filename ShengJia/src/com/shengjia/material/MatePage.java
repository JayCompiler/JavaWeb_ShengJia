...
public class MatePage extends HttpServlet {
	...
	protected void show(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		Page page=sDbo.findpPage(pageNum,10);
		request.setAttribute("pageone", page);
		request.getRequestDispatcher("/adminpage/material.jsp").forward(request,response);
	}
